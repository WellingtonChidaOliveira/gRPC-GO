...
type GetCatergoryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetCatergoryRequest) Reset() {
	*x = GetCatergoryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCatergoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCatergoryRequest) ProtoMessage() {}

func (x *GetCatergoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCatergoryRequest.ProtoReflect.Descriptor instead.
func (*GetCatergoryRequest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{3}
}

func (x *GetCatergoryRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x72, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x22, 0x3c, 0x0a, 0x10, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x32, 0xe3, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67,
	...
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x52, 0x0a, 0x21, 0x43, 0x72, 0x65, 0x61,
	...
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x36, 0x0a, 0x0d,
	0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x09, 0x2e,
	0x70, 0x62, 0x2e, 0x62, 0x6c, 0x61, 0x6e, 0x6b, 0x1a, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x12, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	0x72, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*GetCatergoryRequest)(nil),   // 3: pb.GetCatergoryRequest
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 6: pb.CategoryService.GetCategory:input_type -> pb.GetCatergoryRequest
	...
	5, // 10: pb.CategoryService.GetCategories:output_type -> pb.CategoryListResponse
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCatergoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
