...
type CategoryServiceClient interface {
	...
	GetCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryListResponse, error)
	GetCategory(ctx context.Context, in *GetCatergoryRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *GetCatergoryRequest, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategories(context.Context, *Blank) (*CategoryListResponse, error)
	GetCategory(context.Context, *GetCatergoryRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategories(context.Context, *Blank) (*CategoryListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCategories not implemented")
}
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *GetCatergoryRequest) (*Category, error) {
...
func _CategoryService_GetCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategory(ctx, req.(*GetCatergoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
